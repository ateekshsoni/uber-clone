  ...
  return (
    <>
       <h2 className="text-xl font-semibold py-1">Choose Vehicle</h2>
          ...
          <div  onClick={()=>{ props.setConfirmRidePanel(true) , props.setVehiclePanel(false) }} className="flex w-full mb-2 p-3 border-2  active:border-black rounded-xl items-center justify-between">
            <img
              className="h-16"
