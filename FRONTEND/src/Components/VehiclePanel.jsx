...
const VehiclePanel = (props) => {
  return (
    <>
      ...
      <div
        onClick={() => {
          props.setConfirmRidePanel(true), props.setVehiclePanel(false),props.vehicleType("car");
        }}
        className="flex w-full mb-2 p-3 border-2  active:border-black rounded-xl items-center justify-between"
      >
        <img
          className="h-16"
